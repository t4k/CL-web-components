...
- Web Components
  ...
  - [Footer Global](footer-global.md)
    - Source for [footer-global](https://github.com/caltechlibrary/CL-web-components/blob/main/src/footer-global.js)
    - [demo footer global](demo_footer_global.html)
    - Source for [footer-global-lite](https://github.com/caltechlibrary/CL-web-components/blob/main/src/footer-global-lite.js)
  ...
  - [Textarea CSV](textarea-csv.md) `<textarea-csv></textarea-csv>`
    - Source for [Textarea CSV](https://github.com/caltechlibrary/CL-web-components/blob/main/src/textarea-csv.js)
  ...
  - [Table Sortable](table-sortable.md)
    - Source for [table-sortable](https://github.com/caltechlibrary/CL-web-components/blob/main/src/table-sortable.js)
    - [demo table sortable](demo_table-sortable.html)
  - [UL A to Z List](ul-a-to-z-list.md) `<ul-a-to-z-list></ul-a-to-z-list>`
    - Source for [UL A to Z List](https://github.com/caltechlibrary/CL-web-components/blob/main/src/ul-a-to-z-list.js)
